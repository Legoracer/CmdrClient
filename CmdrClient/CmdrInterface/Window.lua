...
local Gui = game.CoreGui:WaitForChild("Cmdr"):WaitForChild("Frame")
...
function Window:AddLine(text, richText, color)
	if #text == 0 then
    ...
    line.RichText = richText and true or false;
	line.Size =
		UDim2.new(
		line.Size.X.Scale,
		line.Size.X.Offset,
...
function Window:LoseFocus(submit)
	...
	elseif submit then
		self:AddLine(self._errorText, false, Color3.fromRGB(255, 153, 153))
	end
end
